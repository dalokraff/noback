...
MyDLCs.ready = function (self)
	return true
end

MyDLCs.update = function (self, dt)
	return
end

MyDLCs._new_id = function (self)
	self._last_id = self._last_id + 1

	return self._last_id
end

MyDLCs.update_dlc_ownership = function (self)
...
MyDLCs._update_owned_dlcs_cb = function (self, result)
...
MyDLCs._execute_dlc_specific_logic = function (self)
	local request = {
...
MyDLCs._execute_dlc_logic_cb = function (self, result)
	local function_result = result.FunctionResult
...
MyDLCs.get_owned_dlcs = function (self)
	return self._owned_dlcs
end

MyDLCs.get_platform_dlcs = function (self)
	return self._platform_dlcs
end

MyDLCs.updating_dlc_ownership = function (self)
