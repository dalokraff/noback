...
MyLoot.loot_chest_rewards_request_cb = function (self, data, result)
	...
	-- 		print("[MyLoot] Could not get statistics_db, skipping updating statistics...")
	-- 	else
	...
	-- 				Application.warning("[MyLoot] updated_statistics " .. key .. " doesn't exist.")
	-- 			else
...
MyLoot.claim_multiple_achievement_rewards_request_cb = function (self, data, id, start_index, end_index, achievement_ids, result)
	-- print("[MyLoot]:claim_all_achievement_rewards_request_cb: Firing!")
